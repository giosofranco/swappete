...
const Lottery = () => {
    ...
    const getOldDetails = async (index, setWinningNumberOnLoad) => {
        try {
            const {
                data
            } = await UserService.getLotteryDetails(index);
    ...
    return ( <
        div className = "container_wrap container_Lottery" > { /* {console.log(rewardArray,prizeArray,pot , prizeArray[0],100 * 10 ** decimals)} */ }
        ...
        Win
        if 2, 3 or 4 of your ticket numbers match!
        <
        /p> <
        /div> <
        ...
        li >
        <
        Button className = {!nextDraws && "active"
        }
        onClick = {
            () => pastDraws(false)
        } >
            ...
            nextDraws && ( <
...

                {
                    ticketWindow && ( <
                        ...
                        } > * Note: Can 't buy tickets more then 50 at a time</small>

                        <
                        p > 1 Ticket = 20 ANCHOR < /p> <
                        p className = "white" >
                        Ticket purchases are final.Your ANCHOR cannot be returned to you after buying tickets. <
                        /p> <
                ...
                a target = "blank"
                href = {
                    `${API_HOST}drawing/getAll/${page}/25`
                } >
                ...
                <
                p >
                Spend ANCHOR to buy tickets, contributing to the lottery pot.Win prizes
                if 2, 3, or 4 of your ticket numbers < br / >
        ...
        /div> {
            IButton && ( <
                ...
                /div> <
                p >
                Lottery ticket purchases are final.Your Anchor will not be returned to you after you spend it to buy tickets.Tickets are only valid
                for one lottery draw, and will be burned after the draw.Buying tickets does not guarantee you will win anything.Please only participate once you understand the risks. <
                /p>
...

        {
            curentTickets && ( <
                ...
                My Tickets {
                    `(Total: ${currentTicketsArray.length})`
                } <
                /h3> <
                Button className = "close"
                onClick = {
                    () => showCurrentTickets(false)
                } >
                < /Button> <
                div className = "col modal_headerStyle" >
                <
