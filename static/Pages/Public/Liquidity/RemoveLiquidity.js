                    ...
                    onClick = {
                        ...
                        /div> {
                            screenType ?
                                ...
                                >
                                <
                                div className = "centerArrow" > < img src = {
                                    down
                                }
                            alt = "icon" / > < /div> <
                                ...
                                <
                                li > < p > {
                                    tokenOneValue.toFixed(5)
                                } < /p> <span className="white">{tokenOne.symbol}</span > < /li> <
                                li > < p > {
                                    tokenTwoValue.toFixed(5)
                                } < /p><span className="white">{tokenTwo.symbol}</span > < /li> {
                                    checkBNB && < li > < p > < /p>  <span onClick={() => setReceiveBNB(!receiveBNB)}>{receiveBNB ? 'Receive WBNB' : 'Receive BNB'}</span > < /li>} <
                                        ...
                                        div className = "LiquidityboxInput" > {
                                            currentPairAddress && < div className = {
                                                `col InputSelectCurrency_style`
                                            } >
                                            <
                                            label className = "labelTextStyle" > Input < /label> <
                                            label className = "right" > Balance: {
                                                liquidity
                                            } < /label>
                                            ...
                                            onChange = {
                                                (e) => handleLiquidityChange(Number(e.target.value), liquidity, 'pair')
                                            }
                                            min = {
                                                0
                                            }
                                            ...
                                            <
                                            button className = "btn_selectCurrency"
                                            type = "button" >
                                            <
                                            img src = {
                                                tokenOne.icon
                                            ...
                                            span className = "currencyName_textStyle" > {
                                                ...
                                                tokenTwo.symbol
                                            } < /span> { /* <img src={ionicArrowDown} alt="icon" /> */ } <
                                            /button> <
                                            /div> <
                                            /div> <
                                            /div>} <
                                            ...
                                            onChange = {
                                                (e) => handleLiquidityChange(Number(e.target.value), tokenOneDeposit, 'TK1')
                                            }
                                            max = {
                                                false
                                            }
                                            ...
                                            onChange = {
                                                (e) => handleLiquidityChange(Number(e.target.value), tokenTwoDeposit, 'TK2')
                                            }
                                            max = {
                                                false
                                            }
...

                                            {
                                                ...
                                                alt = "icon" / >
                                                    ...
                                                    /span> <
                                                    /div> <
                                                    p > Output is estimated.If the price changes by more than {
                                                        slippagePercentage
                                                    } % your transaction will revert. < /p> <
                                                    /div> <
                                                    ul >
                                                    <
                                                    li > Flip {
                                                ...
                                                onClick = {
                                                    ...
                                                    />} {
                                                        ...
                                                        />} {
                                                            showTransactionModal && < TransactionModal closeTransactionModal = {
                                                            ...
                                                            /Card> {
                                                                ...
                                                                /{tokenTwo?.symbol}</p > < span > {
                                                                        liquidity
                                                                    } < /span></li >
                                                                    <
                                                                    li > < p > {
                                                                        tokenOne.symbol
                                                                    }: < /p><span>{tokenOneDeposit.toFixed(5)} </span > < /li> <
                                                                    li > < p > {
                                                                        tokenTwo ? .symbol
                                                                    }: < /p> <span>{tokenTwoDeposit.toFixed(5)}</span > < /li> <
                                                                    /ul> <
                                                                    /div> <
                                                                    /Card>} <
                                                                    />
