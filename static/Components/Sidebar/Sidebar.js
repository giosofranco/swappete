...
const Sidebar = (props) => {
        ...
        return ( <
                ...
                icon = { < i className = "home_nav_icon" > < /i>} >
                    ...
                    onOpenChange = {
                        () => setSideBarOption("Trade")
                    }
                    icon = { < i className = "trade_nav" > < /i>} >
                        <
                        MenuItem className = {
                            splitLocation[1] === "swap" ? "active" : ""
                        }
                        onClick = {
                            () => handleOnMobile()
                        } >
                        ...
                        MenuItem
                        className = {
                            splitLocation[1] === "liquidity" ? "active" : ""
                        }
                        onClick = {
                            () => handleOnMobile()
                        } >
                                        ...
                                        icon = { < i className = "referrals_nav_icon" > < /i>} >
                                            ...
                                            icon = { < i className = "audits_nav_icon" > < /i>} >
                                                ...
                                                icon = { < i className = "features_nav_icon" > < /i>} >
                                                    ...
                                                    target = "_black" > Automatic Burning < /a> <
                                                    /MenuItem> <
                                                    MenuItem >
                                                    <
                                                    a href = {
                                                    ...
                                                    target = "_black" > Harvest Lockup < /a> <
                                                    /MenuItem> <
                                                    MenuItem >
                                                    <
                                                    a href = {
                                                    ...
                                                    target = "_black" > Automatic Liquidity < /a> <
                                                    /MenuItem> <
                                                    MenuItem >
                                                    <
                                                    a href = {
                                                    ...
                                                    icon = { < i className = "analytics_nav_icon" > < /i>} >
                                                        ...
                                                        icon = { < i className = "question_nav_icon" > < /i>} >
                                                            <
                                                            a href = {
                                                                TUTORIALS
                                                            }
