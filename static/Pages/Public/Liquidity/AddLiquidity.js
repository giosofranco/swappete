                ...
                if (tokenOneApproval && tokenType === 'TK1') {
                    ...
                    return ( <
                            ...
                            div className = "col" > {
                                ...
                                <
                                /button> <
                                /div> { /* <label className="right">Balance: {tokenTwoBalance}</label> */ } <
                                InputSelectCurrency
                                label = "To"
                                onClick = {
                                ...
                                currencyType = {
                                    tokenTwo.icon ? tokenTwo.icon : defaultImg
                                }
                                currnecyName = {
                                    tokenTwoCurrency
                                }
                                            ...
                                            onClick = {
                                                ...
                                                /Card> {
                                                    currentPairAddress &&
                                                        ...
                                                        <
                                                        li > < span > < img className = "sc-fWPcDo bUpjCL"
                                                    alt = "icon 1"
                                                    src = {
                                                        tokenOne ? .icon
                                                    }
                                                    /> <
                                                    img className = "sc-fWPcDo bUpjCL"
                                                    alt = "icon 2"
                                                    src = {
                                                        tokenTwo ? .icon
                                                    }
                                                    ...
                                                    }: < /span> <span>{lpTokenBalance}</span > < /li> <
                                                    li > {
                                                            tokenOne.symbol
                                                        }: < span > {
                                                            tokenOneDeposit
