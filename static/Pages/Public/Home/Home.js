...
const Home = () => {
        ...
        return ( <
                ...
                div className = "col" >
                <
                CardHome className = "col_farm_stacking fullHeight"
                title = "Farms & Staking" >
                <
                div className = "row anchor_swapbtn_metamask_btn lessMargin_bottom" >
                <
                img src = {
                    anchorswapLogoButton
                }
                /> <
                Link to = "/"
                className = "addMetamask_btn" > < img src = {
                    addMetamask
                }
                /></Link >
                <
                ...
                /li> <
                li className = "anchor_harvest_list__valueTextStyle" > ~$ {
                ...
                /div> <
                /div> <
                div className = "row" > {!isUserConnected &&
                    <
                    ...
                    /div>} {
                        ...
                        ANCHOR < /li> <
                            li className = "lottery_winnig__valuesmall" > ~$ {
                                ((rewards ? Math.floor(rewards) : rewards) * anchorBusdValue).toFixed(3)
                            } < /li> <
                            /ul> <
                            /div> <
                            div className = "row" >
                            ...
                            div className = "row" > {!isUserConnected && ( <
                                    ...
                                    div className = "col" >
                                    <
                                    CardHome className = "announcements_cardStyle"
                                    title = "Announcements" >
                                    <
                                    div className = "row" >
                                    <
                                    ...
                                    CardHome className = "totalValueLocked_style"
