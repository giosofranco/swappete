        ...
        const handleApprovalButton = (tokenType) => {
                if (tokenOneApproval && tokenType === 'TK1') {
                    ...
                    return ( <
                            ...
                            div className = "col" >
                            <
                            InputSelectCurrency label = "From"
                            onClick = {
                            ...
                            onChange = {
                                (e) => handleTokenValue(e.target.value, 'TK1')
                            }
                            max = {
                                max
                            }
                            onMax = {
                                () => handleMaxBalance('TK1')
                            }
                            ...
                            onChange = {
                                (e) => handleTokenValue(e.target.value, 'TK2')
                            }
                            max = {
                                false
                            }
                                ...
                                />} {
                                    slippagePercentage &&
                                        ...
                                        div className = "col" > {
                                            ...
                                            p className = "slippage" > Slippage Tolerance: < span > {
                                                    `${slippagePercentage}%`
                                                } < /span></p >
                                                ...
                                                div className = "col button_unlockWallet" > {
                                                    (isDisabled && !isUserConnected) && < Button className = "full"
                                                    onClick = {
                                                        () => setWalletShow(true)
                                                    } > {
                                                        'Unlock Wallet'
                                                                ...
                                                                onClick = {
                                                                    ...
                                                                    /Card> {
                                                                        ...
                                                                        div className = "card_style card_style_bottom" >
                                                                            ...
                                                                            ul >
                                                                            <
                                                                            li > Minimum received: < sapn > {
                                                                                minimumReceived / 10 ** 18
                                                                            } < /sapn></li >
                                                                            <
                                                                            li > Price impact: < sapn > {
                                                                                priceImpact
                                                                            } % < /sapn></li >
                                                                            <
                                                                            li > Liquidity provider fee: < sapn > {
                                                                                liquidityProviderFee()
                                                                            } < /sapn></li >
                                                                            <
                                                                            /ul> <
                                                                            ...
                                                                            /div> {
                                                                                ...
                                                                                />} {
                                                                                    walletShow &&
                                                                                        <
                                                                                        WalletList isWalletShow = {
                                                                                            () => setWalletShow()
                                                                                        }
                                                                                    />
                                                                                } {
                                                                                    showSettings && < SettingsModal handleCloseSettings = {
                                                                                        handleCloseSettings
                                                                                    }
                                                                                    />} {
                                                                                        showRecent && < RecentTransactions handleCloseRecent = {
                                                                                            handleCloseRecent
                                                                                        }
                                                                                        />} {
