...
const Header = (props) => {
        ...
        return ( <
            ...
            onClick = {
                ...
                isUserConnected ? `${isUserConnected.substring(1, 6)}...${isUserConnected.substr(isUserConnected.length - 4)}` : 'Connect'
            } < /Link> <
            /div> {
                isOpen && < ProfileModal closeModal = {
                    () => setModal(!isOpen)
                }
                address = {
                    isUserConnected
