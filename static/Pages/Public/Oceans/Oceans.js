...
function Oceans() {
    return ( <
        ...
        title = "Ethereum"
        content = "Trade, farm, stake and earn on the ERC20 Blockchain easier than ever before." / >
        <
        /div> <
        div className = "col" >
        <
        ...
        title = "Harmony"
        content = "Scaling DeFi and NFT applications across Ethereum and  other chains, nearly zero transaction fee and less than 2 seconds transaction time." / >
        <
        /div> <
        div className = "col" >
        <
        ...
        title = "Polkadot"
        content = "Use blockchain developed rights, a scalable network, the flexible updating of blockchain-enabled functions, staking and bonding." / >
        <
        /div>
