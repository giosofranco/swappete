...
const LiquidityDefault = ({
        ...
        return ( <
                ...
                <
                h2 > Liquidity < /h2> <
                p > Add liquidity to receive ANCHOR - LP tokens < /p> <
                Link to = "#"
                onClick = {
                    () => handleClick(2)
                }
                className = "btn" > Add Liquidity < /Link> <
                /div> <
                    ...
                    !isUserConnected ?
                        ...
                        > {
                            userLpTokens.map((lp, index) =>
                                ...
                                <
                                div className = {
                                    currentIndex === index ? "liquidityListMain openbox" : "liquidityListMain"
                                }
                                onClick = {
                                    () => toggleDropdwon(index)
                                } >
                                <
                                img src = {
                                    lp.token0Obj.icon
                                ...
                                /div> {
                                    currentIndex === index && < ul >
                                        ...
                                        li > Pooled {
                                            lp.token0Obj.symbol
                                        }: < span > < TokenBalance address = {
                                            lp.token0
                                        }
                                    balance = {
                                        lp.token0Deposit
                                    }
                                    /> <img src={lp.token0Obj.icon} alt="icon" / > < /span></li >
                                    <
                                    li > Pooled {
                                        lp.token1Obj.symbol
                                    }: < span > < TokenBalance address = {
                                    ...
                                    /> <img src={lp.token1Obj.icon} alt="icon" / > < /span></li >
                                    <
                                    li > Your pool tokens: < span > {
                                            lp.balance.toFixed(5)
                                        } < /span></li >
                                        <
                                        li > Your pool share: < span > {
                                            lp.poolShare
                                        } % < /span></li >
                                        <
                                        li >
                        ...
                        <
                        p > Don’ t see a pool you joined ? < Link to = "#"
                    onClick = {
                            () => handleClick(3)
                        } > Import it. < /Link></p >
                        <
                        p > Or,
                        if you staked your ANCHOR - LP tokens in
