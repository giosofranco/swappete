...
const ModalSelectToken = ({
        ...
        return ( <
                ...
                <
                button > < img height = "40"
                src = {
                    sortIcon
                }
                onClick = {
                    () => handleOrder(tokenList.reverse())
                }
                alt = "icon" / > < /button> <
                /div> <
                /div> <
                ...
                ul className = "tokenList" > {
                    tokenList && tokenList.map((t, index) =>
                        ...
                        li key = {
                            ...
                            /Link> {
                                (t.isAdd && isAdded) && < span className = "tokenName_textStyle add_token"
                                onClick = {
                                    () => handleTokenList(t)
                                } > Add < /span>} {
                                    t.isDel && < span className = "tokenName_textStyle add_token"
                                    onClick = {
